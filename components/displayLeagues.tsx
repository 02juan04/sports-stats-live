...
export default  function DisplayLeagues({ leagues, selectedLeague, handleSelectedLeague } : props){
    ...
    return (
        <div id="leagues-section" className={`${selectedLeague ? 'lg:h-full lg:col-span-3' : 'w-1/3 tracking-widest'}`}>
            <h2 
                id="leagues-section-header" 
                className="bg-[var(--dashboard-card-headers)] shadow-md mb-20  w-full text-center py-3 px-5 rounded-lg 
